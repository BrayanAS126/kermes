...
const Sign_In = () => {
    ...
    const handleUrlChange = (event) => {
        ...
        console.log("Se está seteando la URL", url);
    };
    ...
    const sendTransaction = async () => {
        try {
            ...
            console.info(
                `Transacción con número de id ${txid} confirmado en el bloque ${slot}`
            );
            ...
            console.error("ERROR SEND TRANSACTIóN", error);
        ...
        <div className="h-screen bg-black">
            <div className="flex flex-col  w-auto h-auto  bg-white">
                <div className="flex flex-col py-24 place-items-center justify-center">
                    <h1 className="text-5xl font-bold pb-10 text-black">
                        kermés
                    </h1>
                    ...
                    {publicKey ? (
                        <div className="flex flex-col py-24 place-items-center justify-center">
                            ...
                            <h1 className="text-2xl font-bold text-black">
                                Tu número de Wallet es {publicKey}
                            </h1>
                            ...
                            <button
                                type="submit"
                                className="inline-flex h-8 w-52 justify-center bg-green-500 font-bold text-white"
                                onClick={() => {
                                    handleSubmit();
                                }}
                            >
